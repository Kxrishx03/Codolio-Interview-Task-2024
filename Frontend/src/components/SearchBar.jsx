...
export function SearchBar({filtervalues, setFilterValues}) {
    ...
    return (
        ...
        <select onClick={(e) => handleFilter(e)} value={filtervalues.category} name='category' className="p-2 rounded border w-2/12 ml-2">
        ...
        <select onClick={(e) => handleFilter(e)} value={filtervalues.currency} name='currency' className="p-2 rounded border w-2/12 ml-2">
